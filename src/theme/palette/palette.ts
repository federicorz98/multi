 ...
 */
export const generatePalette = (colorSchema?: ColorScheme): BasePalette => {
  const { huePrimary, hueError, hueSuccess, hueWarning, saturationMain, lightnessMain, lightnessDark }: ColorScheme =
    colorSchema ?? GALLO_CONFIG;
